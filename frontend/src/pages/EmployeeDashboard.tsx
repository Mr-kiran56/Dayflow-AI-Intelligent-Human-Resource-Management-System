...
export const EmployeeDashboard: React.FC = () => {
  ...
  const hasLoggedShifts = (attStats?.total_days_logged || 0) > 0;
  const complianceRate = hasLoggedShifts ? attStats?.attendance_rate_percentage || 0 : 0;
  const loggedWorkHours = hasLoggedShifts ? attStats?.total_work_hours || 0 : 0;
  const remainingLeaveDays = leaveStats?.total_remaining_days !== undefined ? leaveStats.total_remaining_days : 52;
        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <KpiCard
              ...
              subtitle={hasLoggedShifts ? "Present vs logged workdays" : "0 total days logged"}
              icon={Clock}
            ...
            <KpiCard
              ...
              subtitle={hasLoggedShifts ? "Total hours this month" : "No shift records logged"}
              icon={CreditCard}
              iconBg="bg-indigo-50"
